...
Only the implementation of the optional `vidfab_vulkan` target includes them;
vidfab's public Vulkan wrapper does not expose SDK types.

The headers are used solely for compile-time ABI declarations. At runtime,
vidfab dynamically opens the operating system's Vulkan loader (`vulkan-1.dll`,
