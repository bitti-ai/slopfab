...
SLOPFAB_TEST_CATEGORY(vulkan_runtime_and_pool, "synthetic") {
...
SLOPFAB_TEST_CATEGORY(vulkan_compute_submission, "synthetic") {
  using namespace slopfab::vulkan;
...
SLOPFAB_TEST_CATEGORY(vulkan_tensor_batch_and_workspace, "synthetic") {
...
SLOPFAB_TEST_CATEGORY(vulkan_tensor_layout_and_conversion_ops, "synthetic") {
  using namespace slopfab;
  using namespace slopfab::vulkan;
  if (!Instance::available()) {
    SKIP_UNSUPPORTED_HARDWARE("unavailable prerequisite: !Instance::available()");
