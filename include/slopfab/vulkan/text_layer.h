...
public:
  ...
  static ExactQwenTextLayerScratch create(TensorContext& context,
...
public:
  ...
  static ExactQwenTextLayerStage create(TensorContext& context, const QwenTextLayerConfig& config);
  ...
  static void validate_archive(const SafeTensors& checkpoint, const QwenTextLayerConfig& config);
  ...
  void record(TensorBatch& batch, DeviceTensor& tokens, DeviceTensor& cosine, DeviceTensor& sine,
              ExactQwenTextLayerScratch& scratch, const QwenTextLayerTaps* taps = nullptr) const;
  uint32_t required_operators(const QwenTextLayerTaps* taps = nullptr) const;
  ...
  uint64_t peak_device_bytes(const ExactQwenTextLayerScratch& scratch) const noexcept;
