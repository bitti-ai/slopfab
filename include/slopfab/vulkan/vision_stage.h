...
public:
  ...
  static ExactQwenVisionScratch create(TensorContext& context, const QwenVisionStageConfig& config);
...
public:
  ...
  static ExactQwenVisionPatchStage create(TensorContext& context,
  ...
  void record(TensorBatch& batch, DeviceTensor& pixel_rows, DeviceTensor& learned_index,
...
public:
  ...
  static ExactQwenVisionBlockStage create(TensorContext& context,
                                          const QwenVisionStageConfig& config);
  ...
  uint32_t required_operators() const noexcept;
  uint64_t persistent_bytes() const noexcept;
  void record(TensorBatch& batch, DeviceTensor& residual, DeviceTensor& cosine, DeviceTensor& sine,
...
public:
  ...
  static ExactQwenVisionMergerStage create(TensorContext& context,
                                           const QwenVisionStageConfig& config);
  ...
  uint32_t required_operators() const noexcept;
  uint64_t persistent_bytes() const noexcept;
  void record(TensorBatch& batch, DeviceTensor& visual_residual, DeviceTensor& output,
              ExactQwenVisionScratch& scratch) const;
...
public:
  ...
  void unload() noexcept;
  bool loaded() const noexcept;
  void encode(const text::QwenPixelValues& image, text::QwenVisionTrace* trace = nullptr);
