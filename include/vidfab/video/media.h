...
// the vidfab_core target's definitions would therefore be told the demuxer
...
#if !defined(VIDFAB_WITH_FFMPEG)
#error \
    "vidfab: VIDFAB_WITH_FFMPEG is not defined. Define it as 1 or 0 to match the library you are linking (in this build tree the vidfab_core target defines it for you)."
#endif
